...
class LocalPlanner:
    ...
    def _compute_parameters(
        ...
        for c0 in c_list:
            for c1 in c_list:
                parameters.append(self._fit_cubic(start, end, c0, c1))
                ...
                if wp.right_lane_marking.lane_change & carla.LaneChange.Right:
                    ...
                    if (
                        ...
                        parameters.append(self._fit_cubic(start, end_offset, c0, c1))

                if wp.left_lane_marking.lane_change & carla.LaneChange.Left:
